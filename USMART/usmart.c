...
//{
//   __HAL_TIM_CLEAR_FLAG(&TIM3_Handler,TIM_FLAG_UPDATE);//清除中断标志位 
//   __HAL_TIM_SET_AUTORELOAD(&TIM3_Handler,0XFFFF);     //将重装载值设置到最大
...
//{
//	if(__HAL_TIM_GET_FLAG(&TIM3_Handler,TIM_FLAG_UPDATE)==SET)//在运行期间,产生了定时器溢出
//	{
//		usmart_dev.runtime+=0XFFFF;
//	}
//	usmart_dev.runtime+=__HAL_TIM_GET_COUNTER(&TIM3_Handler);
...
//       __HAL_TIM_SET_COUNTER(&TIM3_Handler,0);;    //清空定时器的CNT
//       __HAL_TIM_SET_AUTORELOAD(&TIM3_Handler,100);//恢复原来的设置
//   }
...
//{ 
//   TIM3_Handler.Instance=TIM3;                          //通用定时器4
//   TIM3_Handler.Init.Prescaler=psc;                     //分频
//   TIM3_Handler.Init.CounterMode=TIM_COUNTERMODE_UP;    //向上计数器
//   TIM3_Handler.Init.Period=arr;                        //自动装载值
//   TIM3_Handler.Init.ClockDivision=TIM_CLOCKDIVISION_DIV1;
//   HAL_TIM_Base_Init(&TIM3_Handler);
//   HAL_TIM_Base_Start_IT(&TIM3_Handler); //使能定时器4和定时器4中断 					 
//}
