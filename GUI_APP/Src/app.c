 ...
 * @version: 1.0
 * @Author: YLDS
 * @Date: 2021-04-05 21:47:11
 * @LastEditTime: 2021-04-24 17:03:20
 */
#include "app.h"
#include "login_win.h"
#include "main_win.h"
...
/**
 * @brief: 类似于android系统中的toast提示
 * @version: 1.0
 * @Date: 2021-04-24 17:02:46
 * @param {const char} *msg 提示消息
 * @param {uint16_t} time 多长后自动关闭消息,单位ms
 */
...
extern u8 chart_flag;
#define BACK_BTN_TITLE LV_SYMBOL_LEFT " Back\n" //返回按钮的文本内容,加\n是为了加大点击区域

/**
 * @brief: 返回按钮专用的事件回调函数
 * @version: 1.0
 * @Date: 2021-04-24 17:02:39
 * @param {lv_obj_t} *obj
...
/**
 * @brief: 创建一个通用的窗体,它具有标题和返回按钮
 * @version: 1.0
 * @Date: 2021-04-24 17:02:07
 * @param {lv_obj_t} *parent 父对象
 * @param {const char} *title 窗体的标题
 */
